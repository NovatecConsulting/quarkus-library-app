...
internal class BorrowBookRequestTest : AbstractPayloadTest<BorrowBookRequest>() {
    ...
    @Nested inner class `borrower property validation` {
        ...
        @Test
        fun `any values between 1 and 50 characters are valid`() = (1..50)
        ...
        @ParameterizedTest
        fun `valid value examples`(borrower: String) {
        ...
        @Nested inner class `invalid value examples` {
            ...
            @Test
            fun `more than 50 character string`() {
            ...
            @ParameterizedTest
            fun `special characters`(borrower: String) {
